...
% imdb = load('./net/imdb_9_3_1482_highway.mat');
% imdb = load('./net/imdb_9_3_1482_pedestrians.mat');
% imdb = load('./net/imdb_9_3_482_office.mat');
% imdb = load('./net/imdb_9_3_982_pets2006.mat');
...
num = round(column/batchsize - 0.5);
