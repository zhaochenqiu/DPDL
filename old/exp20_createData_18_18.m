...
save('./data/imdb_18_3_982_highway_train.mat','imdb','-v7.3');
clear imdb;
...
save('./data/imdb_18_3_1482_highway_test.mat','imdb','-v7.3');
clear imdb;
...
imdb = createImdb_plus(im_pa,im_ft,tr_pa,tr_ft,[401,437],1,'train');
save('./data/imdb_18_3_482_pedestrians_train.mat','imdb','-v7.3');
clear imdb;
...
imdb = createImdb_plus(im_pa,im_ft,tr_pa,tr_ft,[901,937],1);
save('./data/imdb_18_3_982_pedestrians_test.mat','imdb','-v7.3');
clear imdb;
...
imdb = createImdb_plus(im_pa,im_ft,tr_pa,tr_ft,[1401,1437],1,'train');
save('./data/imdb_18_3_1482_office_train.mat','imdb','-v7.3');
clear imdb;
...
imdb = createImdb_plus(im_pa,im_ft,tr_pa,tr_ft,[901,937],1);
save('./data/imdb_18_3_982_office_test.mat','imdb','-v7.3');
clear imdb;
