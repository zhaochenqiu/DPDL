...
if frames_train_fg > 0
    ...
    %    imdb_fg = getImdb(im_pa,im_ft,tr_pa,tr_ft,pos_fg(i),size_block,rag_block,'train');
        imdb_fg = getImdb_plus(im_pa,im_ft,tr_pa,tr_ft,maxdis,pos_fg(i),size_block,rag_block,'train');
...
if frames_train_bk > 0
    ...
    %    imdb_bk = getImdb(im_pa,im_ft,tr_pa,tr_ft,pos_bk(i),size_block,rag_block,'train');
        imdb_bk = getImdb_plus(im_pa,im_ft,tr_pa,tr_ft,maxdis,pos_bk(i),size_block,rag_block,'train');
...
%    imdb    = getImdb(im_pa,im_ft,tr_pa,tr_ft,pos,size_block,rag_block);
    imdb    = getImdb_plus(im_pa,im_ft,tr_pa,tr_ft,maxdis,pos,size_block,rag_block);
